...
const Hero = () => {
  return (
    <div className="flex flex-col gap-6 bg-[#0E150F] text-white min-[1200px]:flex-row min-[1200px]:justify-between">
      ...
      <div className="flex items-end justify-center gap-1 min-[1200px]:h-[710px] min-[1200px]:w-[50%]">
        ...
        <div className="relative h-[300px] w-[40%] rounded-tl-[300px] border min-[900px]:h-[330px] lg:h-[400px] min-[1200px]:h-[708px] cursor-pointer"></div>
      </div>
    </div>
  );
};
