...
const Hero = () => {
  return (
    <div className="flex flex-col gap-6 bg-[#0E150F] text-white min-[1200px]:flex-row min-[1200px]:justify-around">
      <div className="flex flex-col items-center gap-6 px-4 pt-[4.5rem] text-center min-[370px]:gap-8 min-[1200px]:w-[60%] min-[1200px]:items-start min-[1200px]:px-[3rem] min-[1200px]:text-start">
        <h1 className="text-sm font-bold text-[#10A969] min-[370px]:text-[16px] min-[1200px]:text-[20px]">
          SELECT SAFARIS EAST AFRICA CO.
        </h1>
        <p className="max-w-[50rem] text-2xl font-bold leading-[40px] min-[370px]:text-3xl min-[370px]:leading-[50px] min-[400px]:text-[36px] min-[700px]:text-5xl min-[700px]:leading-[70px] min-[1200px]:max-w-[100%] min-[1200px]:text-[60px] min-[1200px]:leading-[80px]">
      ...
      <div className="flex items-end justify-center gap-1 min-[1200px]:h-[738px] min-[1200px]:w-[40%]">
