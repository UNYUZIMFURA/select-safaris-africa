...
const Partners = () => {
    ...
    return (
        <div className="flex flex-col items-center bg-white py-10 lg:py-[3rem]">
            <div className="flex max-w-[30rem] flex-col items-center gap-6 text-center lg:max-w-[35rem]">
                <span className="text-xl font-bold text-brand">
                    TRUSTED PARTNERS
                </span>
                <h2 className="text-2xl font-bold leading-10 text-tertiary2 md:text-[1.6rem] lg:text-[1.9rem] xl:text-[2.2rem] xl:leading-[3rem] 2xl:text-[2.2rem]">
                ...
                <p className="text-[#000B0B] lg:text-[1.1rem] xl:max-w-[30rem]">
                    We are proud to partner with a network of trusted partners
                    including:
                </p>
            </div>
