...
const Description1 = () => {
  return (
    <div className="py-7 px-4 flex flex-col items-center gap-6 md:gap-8 text-white border-white bg-white md:flex-row lg:gap-[3rem] xl:justify-between lg:py-[5rem] lg:px-[2rem] 2xl:px-[7rem]">
      <div className="w-full md:max-w-[690px] p-4 h-[20rem] md:h-[22rem] border rounded-[20px] lg:h-[27rem]"></div>
      <div className="flex flex-col gap-6 md:max-w-[47rem]">
        ...
        <span
          className="text-[#AAB2BA] lg:text-[20px]">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad
          minim veniam, quis nostrud exercitation
        </span>
